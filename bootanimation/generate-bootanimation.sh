...
prebuilts/tools-lineage/${HOST_OS}-x86/bin/mogrify -resize $RESOLUTION -colors 250 "$OUT/bootanimation/"*"/"*".png"
...
${SOONG_ZIP:-soong_zip} -L 0 -o "$OUT/bootanimation.zip" -C "$OUT/bootanimation" -D "$OUT/bootanimation"
