...
ifeq ($(or $(FULL_KERNEL_BUILD), $(FULL_KERNEL_GKI_BUILD)),true)
MODULES_INTERMEDIATES := $(KERNEL_BUILD_OUT_PREFIX)$(call intermediates-dir-for,PACKAGING,kernel_modules)
endif # FULL_KERNEL_BUILD or FULL_KERNEL_GKI_BUILD
...
$(TARGET_PREBUILT_INT_KERNEL_GKI): $(KERNEL_GKI_CONFIG) $(DEPMOD) $(DTC)
	...
	$(hide) if grep -q '=m' $(KERNEL_GKI_CONFIG); then \
			...
			echo "Installing GKI Kernel Modules"; \
			$(call make-gki-kernel-target,INSTALL_MOD_PATH=$(MODULES_INTERMEDIATES) INSTALL_MOD_STRIP=1 modules_install); \
		fi
