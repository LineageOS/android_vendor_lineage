...
$(KERNEL_BIN):
	...
	$(hide) cd $(KERNEL_PATH) && ./tools/bazel --output_user_root=$(KERNEL_OUT)/bazel-out run --experimental_convenience_symlinks=ignore --cpu=$(KERNEL_ARCH) //$(KERNEL_SRC):$(TARGET_KERNEL_PLATFORM_TARGET)_dist -- --destdir=$(KERNEL_OUT)/dist
endif
