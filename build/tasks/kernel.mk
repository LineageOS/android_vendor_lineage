...
ifeq ($(TARGET_KERNEL_CLANG_COMPILE),true)
    ...
    PATH_OVERRIDE := $(PATH_OVERRIDE):$(TARGET_KERNEL_CLANG_PATH)/bin
    LD_LIBRARY_PATH_OVERRIDE := $(LD_LIBRARY_PATH_OVERRIDE):$(TARGET_KERNEL_CLANG_PATH)/lib64
    ifeq ($(KERNEL_CC),)
...
PATH_OVERRIDE := $(PATH_OVERRIDE):$(KERNEL_TOOLCHAIN_PATH_gcc)/bin

# System tools are no longer allowed on 10+
LD_LIBRARY_PATH_OVERRIDE := $(LD_LIBRARY_PATH_OVERRIDE):$(BUILD_TOP)/prebuilts/tools-lineage/$(HOST_OS)-x86/lib
LD_LIBRARY_PATH_OVERRIDE := $(LD_LIBRARY_PATH_OVERRIDE):$(BUILD_TOP)/prebuilts/openssl/$(HOST_OS)-x86/1.1.1/lib
PATH_OVERRIDE := $(PATH_OVERRIDE):$(BUILD_TOP)/prebuilts/tools-lineage/$(HOST_OS)-x86/bin

KERNEL_ENV_VARIABLES := \
    LD_LIBRARY_PATH=$(LD_LIBRARY_PATH_OVERRIDE):$$LD_LIBRARY_PATH \
...
$(KERNEL_ENV_VARIABLES) $(KERNEL_MAKE_CMD) $(KERNEL_MAKE_FLAGS) -C $(KERNEL_SRC) O=$(KERNEL_BUILD_OUT_PREFIX)$(1) ARCH=$(KERNEL_ARCH) $(KERNEL_CROSS_COMPILE) $(KERNEL_CLANG_TRIPLE) $(KERNEL_CC) $(2)
endef
