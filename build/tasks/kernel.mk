...
ifneq ($(filter $(FULL_RECOVERY_KERNEL_BUILD),true)$(filter $(FULL_KERNEL_BUILD),true)$(TARGET_KERNEL_PLATFORM_TARGET),)
...
endif # FULL_RECOVERY_KERNEL_BUILD or FULL_KERNEL_BUILD or TARGET_KERNEL_PLATFORM_TARGET
...
$(TARGET_PREBUILT_INT_KERNEL): $(DEPMOD) $(KERNEL_MODULES_PARTITION_FILE_LIST) $(SYSTEM_KERNEL_MODULES_PARTITION_FILE_LIST)
	...
	$(hide) cd $(KERNEL_PATH) && ./tools/bazel --output_user_root=$(KERNEL_OUT)/bazel-out run --experimental_convenience_symlinks=ignore --cpu=$(KERNEL_ARCH) //$(KERNEL_SRC):$(TARGET_KERNEL_PLATFORM_TARGET)_dist -- --destdir=$(KERNEL_OUT)
	$(if $(BOOT_KERNEL_MODULES),\
