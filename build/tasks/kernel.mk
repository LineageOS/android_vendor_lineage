...
ifeq "$(wildcard $(KERNEL_SRC) )" ""
    ifneq ($(TARGET_PREBUILT_KERNEL),)
        ...
        ifneq ($(filter kernel/prebuilts/%,$(TARGET_FORCE_PREBUILT_KERNEL)),)
    ...
    ifeq ($(TARGET_KERNEL_CONFIG),)
        ...
        ifneq ($(TARGET_FORCE_PREBUILT_KERNEL),)
            ifeq ($(filter kernel/prebuilts/%,$(TARGET_FORCE_PREBUILT_KERNEL)),)
                # If the force prebuilt kernel is not GKI kernel
