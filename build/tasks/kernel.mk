...
define make-kernel-config
	KCONFIG_CONFIG=$(1)/.kconfig_allconfig $(KERNEL_SRC)/scripts/kconfig/merge_config.sh -m $(2)
	$(call internal-make-kernel-target,$(1),KCONFIG_ALLCONFIG=.kconfig_allconfig VARIANT_DEFCONFIG=$(VARIANT_DEFCONFIG) SELINUX_DEFCONFIG=$(SELINUX_DEFCONFIG) alldefconfig)
