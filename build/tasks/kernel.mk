...
ifeq ($(TARGET_KERNEL_CLANG_COMPILE),true)
    ...
    KERNEL_CLANG_VERSION := $(find prebuilts/clang/host/$(HOST_OS)-x86/ -name AndroidVersion.txt -exec grep -l $(TARGET_KERNEL_CLANG_VERSION) "{}" \; | sed -e 's|/AndroidVersion.txt$||g;s|^.*/||g')
