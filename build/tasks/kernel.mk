...
else ifeq ($(NEED_KERNEL_MODULE_ODM),true)
KERNEL_MODULES_OUT := $(TARGET_OUT_ODM)
KERNEL_DEPMOD_STAGING_DIR := $(KERNEL_BUILD_OUT_PREFIX)$(call intermediates-dir-for,PACKAGING,depmod_odm)
KERNEL_MODULE_MOUNTPOINT := odm
$(INSTALLED_ODMIMAGE_TARGET): $(TARGET_PREBUILT_INT_KERNEL)
else
