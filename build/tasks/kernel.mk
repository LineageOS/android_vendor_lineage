...
#   NEED_KERNEL_MODULE_PRODUCT         = Optional, if true, install kernel
#                                          modules in product instead of vendor
...
else ifeq ($(NEED_KERNEL_MODULE_PRODUCT),true)
KERNEL_MODULES_OUT := $(TARGET_COPY_OUT_PRODUCT)/vendor_overlay/$(PRODUCT_TARGET_VNDK_VERSION)
