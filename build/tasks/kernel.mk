...
ifneq ($(TARGET_KERNEL_CLANG_COMPILE),)
    # Only set clang-4053586 if TARGET_KERNEL_CLANG_VERSION hasn't been set by the device config
    TARGET_KERNEL_CLANG_VERSION ?= clang-4053586
