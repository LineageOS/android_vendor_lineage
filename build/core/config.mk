...
LINEAGE_SRC_API_DIR := $(TOPDIR)prebuilts/lineagesdk/api
...
FRAMEWORK_LINEAGE_PLATFORM_API_FILE := $(TOPDIR)vendor/lineagesdk/api/lineage_current.txt
FRAMEWORK_LINEAGE_PLATFORM_REMOVED_API_FILE := $(TOPDIR)vendor/lineagesdk/api/lineage_removed.txt
