...
FRAMEWORK_CM_PLATFORM_API_FILE := $(TOPDIR)vendor/lineagesdk/api/cm_current.txt
FRAMEWORK_CM_PLATFORM_REMOVED_API_FILE := $(TOPDIR)vendor/lineagesdk/api/cm_removed.txt
