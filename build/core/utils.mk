...
$(strip \
  ...
  $(if $(call math_gt_or_eq,$(a_major),$(b_major)),$(if $(call math_gt_or_eq,$(a_minor),$(b_minor)),1,0),0)
)
endef
...
$(strip \
  ...
  $(eval b_major := $(word 1,$(subst ., ,$(2)))) \
  $(eval b_minor := $(word 2,$(subst ., ,$(2)))) \
  $(if $(call math_lt_or_eq,$(a_major),$(b_major)),$(if $(call math_lt_or_eq,$(a_minor),$(b_minor)),1,0),0)
)
endef
