...
def fetch_dependencies(repo_path):
    ...
    if os.path.exists(dependencies_path):
        ...
        for dependency in dependencies:
            ...
            if not 'revision' in dependency:
                dependency['revision'] = get_default_or_fallback_revision(dependency['repository']);
...
def get_default_or_fallback_revision(repo_name):
    ...
    print("https://api.github.com/repos/LineageOS/" + repo_name + "/branches")
    ...
    githubreq = urllib.request.Request("https://api.github.com/repos/LineageOS/" + repo_name + "/tags")
    add_auth(githubreq)
    ...
    print("Default revision %s not found in %s. Bailing." % (default_revision, repository['name']))
...
if depsonly:
    ...
    for repository in repositories:
        ...
        if re.match(r"^android_device_[^_]*_" + device + "$", repo_name):
            ...
            device_repository = {'repository':repo_name,'target_path':repo_path,'revision':revision}
