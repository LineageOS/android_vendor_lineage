...
ifneq ($(TARGET_TRUST_USB_CONTROL_ENABLE),)
    $(call soong_config_set,lineage_usb,usb_control_enable,$(TARGET_TRUST_USB_CONTROL_ENABLE))
endif
ifneq ($(TARGET_TRUST_USB_CONTROL_DISABLE),)
    $(call soong_config_set,lineage_usb,usb_control_disable,$(TARGET_TRUST_USB_CONTROL_DISABLE))
endif
