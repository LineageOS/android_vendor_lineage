...
SOONG_CONFIG_lineageGlobalVars += \
    ...
    target_trust_control_path \
    target_trust_control_enable \
    target_trust_control_disable \
...
TARGET_TRUST_CONTROL_PATH ?= /proc/sys/kernel/deny_new_usb
TARGET_TRUST_CONTROL_ENABLE ?= 1
TARGET_TRUST_CONTROL_DISABLE ?= 0
...
SOONG_CONFIG_lineageGlobalVars_target_trust_control_path := $(TARGET_TRUST_CONTROL_PATH)
SOONG_CONFIG_lineageGlobalVars_target_trust_control_enable := $(TARGET_TRUST_CONTROL_ENABLE)
SOONG_CONFIG_lineageGlobalVars_target_trust_control_disable := $(TARGET_TRUST_CONTROL_DISABLE)
