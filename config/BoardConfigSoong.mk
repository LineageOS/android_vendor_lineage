...
ifneq ($(TARGET_QTI_VIBRATOR_EFFECT_LIB),)
$(call soong_config_set,qti_vibrator,effect_lib,$(TARGET_QTI_VIBRATOR_EFFECT_LIB))
endif
ifneq ($(TARGET_QTI_VIBRATOR_USE_EFFECT_STREAM),)
$(call soong_config_set,qti_vibrator,use_effect_stream,$(TARGET_QTI_VIBRATOR_USE_EFFECT_STREAM))
endif
