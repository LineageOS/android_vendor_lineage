...
QSSI_PLATFORMS := $(UM_4_9_FAMILY) $(UM_4_14_FAMILY) $(UM_4_19_FAMILY)
...
# Add display-commonsys-intf to PRODUCT_SOONG_NAMESPACES for QSSI platforms
ifneq ($(filter $(QSSI_PLATFORMS),$(TARGET_BOARD_PLATFORM)),)
