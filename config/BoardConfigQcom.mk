...
QSSI_TARGETS := $(UM_4_9_FAMILY) $(UM_4_14_FAMILY) $(UM_4_19_FAMILY)
...
# Add display-commonsys-intf to PRODUCT_SOONG_NAMESPACES for QSSI targets
ifneq ($(filter $(QSSI_TARGETS),$(TARGET_BOARD_PLATFORM)),)
