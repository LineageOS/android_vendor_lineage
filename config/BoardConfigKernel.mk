...
ifeq ($(HOST_OS),darwin)
  ...
  KERNEL_MAKE_FLAGS += HOSTLDFLAGS="-I$(BUILD_TOP)/external/elfutils/libelf -I/usr/local/opt/openssl/include -L/usr/local/opt/openssl/lib"
else
  KERNEL_MAKE_FLAGS += HOSTCFLAGS="-I/usr/include -L/usr/lib64"
  KERNEL_MAKE_FLAGS += HOSTLDFLAGS="-I/usr/include -L/usr/lib64"
endif
